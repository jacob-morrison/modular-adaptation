...
baselines_path = "/net/nfs.cirrascale/allennlp/jacobm/modular_adaptation/new_baselines_results/safety/"
faeze_path = "/net/nfs.cirrascale/allennlp/jacobm/modular_adaptation/new_baselines_results/safety-for-faeze/"
...
df.to_csv("/net/nfs.cirrascale/allennlp/jacobm/modular_adaptation/safety/collected/full_results.csv", index=False)

with open("/net/nfs.cirrascale/allennlp/jacobm/modular_adaptation/safety/collected/results.json", "w") as f_out:

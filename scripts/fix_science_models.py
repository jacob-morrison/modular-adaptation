...
for model in baselines:
    ...
    print_and_run("rm tmp_model_directory/special_tokens_map.json tmp_model_directory/tokenizer.model tmp_model_directory/tokenizer_config.json")
    print_and_run("ls tmp_model_directory/")
    print_and_run("cp llama_tokenizer_4k/special_tokens_map.json tmp_model_directory/")
    print_and_run("cp llama_tokenizer_4k/tokenizer.model tmp_model_directory/")
    print_and_run("cp llama_tokenizer_4k/tokenizer_config.json tmp_model_directory/")
    print_and_run("cp config.json tmp_model_directory/")
    print_and_run("ls tmp_model_directory/")

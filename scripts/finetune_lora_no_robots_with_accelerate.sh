...
python open_instruct/merge_lora.py \
    ...
    --lora_model_name_or_path /net/nfs.cirrascale/allennlp/jacobm/modular_adaptation/checkpoints/no_robots_${MODEL_SIZE}_lora/ \
    --output_dir /net/nfs.cirrascale/allennlp/jacobm/modular_adaptation/checkpoints/no_robots_${MODEL_SIZE}_lora_merged/ \
    --save_tokenizer

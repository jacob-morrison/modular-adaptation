...
datasets = [
    ...
    ("01HRRX6CCBE1X0KQBSNF1YFWHS", "ties-llama_2_7b-tulu_all_0.1-science_upsample_0.9", "/model", "merged_models"),
    ...
    ("", "slerp-llama_2_7b-tulu_all_0.1-science_1000_0.9", "/model", "merged_models"),

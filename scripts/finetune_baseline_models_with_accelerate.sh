...
accelerate launch \
    ...
    --use_slow_tokenizer \
    --train_file /net/nfs.cirrascale/allennlp/jacobm/tulu_data/tulu-v2/hard_coded_filtered_data.jsonl \
    --max_seq_length 2048 \
    ...
    --weight_decay 0. \
    --num_train_epochs 2 \
    --output_dir /net/nfs.cirrascale/allennlp/jacobm/modular_adaptation/checkpoints/test-model/ \
    --with_tracking \
